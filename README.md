...
Coleção e Gerenciamento: infraestrutura de User e Adm onde é orquestrado um sistema para usuários abrirem "pacotes", colecionarem itens e gerenciarem seu inventário digital. Os Adm consegue validar as missões de cada area respectivas

ADM:<img width="831" height="473" alt="image" src="https://github.com/user-attachments/assets/a0a2bf98-3983-4f69-a387-761199407e40" />
User:<img width="1432" height="934" alt="image" src="https://github.com/user-attachments/assets/22c15330-4669-4587-b035-17099db2756c" />



Motor de Gamificação e Ranking Customizado: Implementação de um placar de líderes (Leaderboard). A regra de negócio principal do ranking foi desenvolvida para calcular o total de figurinha de cada usuário, em vez da simples contagem de entradas únicas, exigindo consultas otimizadas no banco de dados.Engajando esse usuario á fazer as missões e comprar mais figurinhas, consequentemente subir no ranking

<img width="789" height="480" alt="image" src="https://github.com/user-attachments/assets/305598b8-98ba-490b-a56d-384fe0b4b4da" />

## Interface Interativa:O user vai fazer seu cadastro ou loga se o caso se já casatrou
...
<img width="1906" height="960" alt="image" src="https://github.com/user-attachments/assets/4a7a29da-cc73-40ef-bbc5-a1ac69ad22fe" />
 ...
 Ele vai realizar as missões dasa area de négocio:
